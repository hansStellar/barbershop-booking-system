...
export default function MyApp({ Component, pageProps }) { // Component is the page being rendered /dashboard /index etc... and pageProps is the props passed on each page
